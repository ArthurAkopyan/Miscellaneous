...
#include "Museum290.h"
#include "GravityNormal.h"
#include "Museum290Character.h"

// Sets default values
AGravityNormal::AGravityNormal()
{
	...
	HitBox->OnComponentBeginOverlap.AddDynamic(this, &AGravityNormal::OnPlayerEnterBox);

}

// Called when the game starts or when spawned
void AGravityNormal::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AGravityNormal::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void AGravityNormal::OnPlayerEnterBox(UPrimitiveComponent* OverLapComp, AActor* OtherThing, UPrimitiveComponent* OtherComp, int32 OtherIndex, bool FromSweep, const FHitResult& Sweep)
{
	...
	if (Stuff != NULL)
	{
		...
		Stuff->GetCharacterMovement()->GravityScale = 1.0f;
		Stuff->GetCharacterMovement()->MaxWalkSpeed = 700.0f;
		Destroy();
	}
	else
	{
